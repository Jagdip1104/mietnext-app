...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Magic Link für Mieter oder normaler Login
    ...
    <main style={{ fontFamily: "'Georgia', serif", backgroundColor: '#fafaf8', minHeight: '100vh' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          <a href="/login" style={{ fontSize: '14px', color: '#666', textDecoration: 'none', padding: '8px 16px', borderRadius: '8px' }}>
            Einloggen
          </a>
          <a href="/register" style={{ fontSize: '14px', backgroundColor: '#1a1a1a', color: '#fff', padding: '10px 20px', borderRadius: '8px', textDecoration: 'none', fontFamily: 'system-ui, sans-serif' }}>
            Kostenlos starten →
          </a>
        </div>
      </nav>
      ...
      <section style={{ maxWidth: '960px', margin: '0 auto', padding: '80px 48px 60px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <a href="/register" style={{ backgroundColor: '#1a1a1a', color: '#fff', padding: '14px 28px', borderRadius: '10px', textDecoration: 'none', fontSize: '15px', fontFamily: 'system-ui, sans-serif' }}>
            Kostenlos starten – 0 €
          </a>
          <a href="/login" style={{ backgroundColor: '#fff', color: '#444', padding: '14px 28px', borderRadius: '10px', textDecoration: 'none', fontSize: '15px', border: '1px solid #ddd', fontFamily: 'system-ui, sans-serif' }}>
            Einloggen
          </a>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#1a1a1a', padding: '80px 48px' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '36px', fontWeight: '400', color: '#fff', marginBottom: '48px', letterSpacing: '-1px' }}>
